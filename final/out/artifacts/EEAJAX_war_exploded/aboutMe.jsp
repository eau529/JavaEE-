            ...
            function getUserInfo() {
                $.ajax({
                    ...
                    success: function (result) {
                        var html = "";
                        var user = result;
                        html += "<label class=\"MY_fontSize4\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"/>&nbsp;个人资料：&nbsp;</label>\n" +
                            "<span class=\"MY_fontSize3\">" + user.info + "</span>\n" +
                            "<br/>\n" +
                            "<br/>\n" +
                            "<label class=\"MY_fontSize4\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"/>&nbsp;个人爱好：&nbsp;</label>\n" +
                            "<span class=\"MY_fontSize3\">" + user.hobby + "</span>\n" +
                            "<br/>\n" +
                            "<br/>\n" +
                            "<label class=\"MY_fontSize4\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"/>&nbsp;个人QQ：&nbsp;</label>\n" +
                            "<span class=\"MY_fontSize3\">" + user.qq + "</span>\n" +
                            "<br/>\n" +
                            "<br/>\n" +
                            "<label class=\"MY_fontSize4\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"/>&nbsp;个人邮箱：&nbsp;</label>\n" +
                            "<span class=\"MY_fontSize3\">" + user.email + "</span>\n" +
                            "<br/>\n" +
                            "<br/>\n" +
                            "<label class=\"MY_fontSize4\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"/>&nbsp;个人简介：&nbsp;</label>\n" +
                            "<br/><br/>\n" +
